...
# Bot token @Botfather
BOT_TOKEN = os.environ.get("BOT_TOKEN", "8321121313:AAFW63D4-KUwRv-BeJ7waoZ-KXX6_p0DUeA")

# Your API ID from my.telegram.org
API_ID = int(os.environ.get("API_ID", "30341150"))

# Your API Hash from my.telegram.org
API_HASH = os.environ.get("API_HASH", "4c991837ffc4d5f80f1faf73b8d0ef53")

# Your Owner / Admin Id For Broadcast 
ADMINS = int(os.environ.get("ADMINS", "8278270208"))
...
DB_URI = os.environ.get("DB_URI", "mongodb+srv://Yash123:pooja@141207@cluster0.vhevozb.mongodb.net/?appName=Cluster0") # Warning - Give Db uri in deploy server environment variable, don't give in repo.
