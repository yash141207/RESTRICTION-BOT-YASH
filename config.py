...
DB_URI = os.environ.get("DB_URI", "mongodb+srv://Yash:Yu@141207@cluster0.f6pcm0o.mongodb.net/?appName=Cluster0") # Warning - Give Db uri in deploy server environment variable, don't give in repo.
